...
<?php if(isset($nextEvent['MeetupEvent']['datetime'])): ?>
    <p>Our next meetup is scheduled for <strong>
    <?php echo $this->Time->format('l, j M Y', $nextEvent['MeetupEvent']['datetime']); ?></strong>
