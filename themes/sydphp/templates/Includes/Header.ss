	...
	<div id="app_wrap">
		...
		<div id="app_intro">
			...
			<div id="auth">
				<% if GetLoggedIn %>
					<% control GetLoggedIn %>
						<p>Signed in as <a href="/member/">$FirstName $LastName ($Email)</a> - <a href="/logout/">sign out</a></p>
					<% end_control %>
				<% else %>
					<p><a href="/member/">join</a></p>
				<% end_if %>
			</div>
